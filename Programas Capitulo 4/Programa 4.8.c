...
int main(void)
{
    int local_a; /* Nota que a es una variable local. */
    local_a = 1; /* Se asigna un valor a la variable local a. */
...
void funcion1(int *b, int *c)
{
    ...
    local_d = 3; /* Nota que se hace referencia a la variable local local_d. */
    (*b)++;
    (*c) += 2;
